CryptoControl - Ruby Crypto News API
=========================

Official Ruby client for the [CryptoControl.io](https://cryptocontrol.io) API. The CryptoControl python client lets developers access rich formatted articles from crypto news sources from all around the world.
